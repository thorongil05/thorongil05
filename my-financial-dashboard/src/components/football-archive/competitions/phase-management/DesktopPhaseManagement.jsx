import {
    Box, Paper, Stack, Grid, Typography, Button, TextField,
            ...
            <Grid item xs={12} md={4} lg={3}>
                <Stack spacing={2} sx={{ height: '100%' }}>
                    <Paper variant="outlined" sx={{ p: 2, borderRadius: 2, bgcolor: 'background.default' }}>
                        ...
                        <Stack spacing={1}>
                            {isAdding && (
                                <Paper elevation={0} sx={{ p: 1.5, border: '1px dashed', borderColor: 'primary.main', bgcolor: 'primary.light', bgopacity: 0.1 }}>
                                    <Stack spacing={1.5}>
                                        <TextField
                                            size="small"
                            ...
                            {phases.map(phase => (
                                <Card
                                    ...
                                    sx={{
                                        ...
                                        boxShadow: selectedPhaseId === phase.id ? '0 2px 8px rgba(0,0,0,0.1)' : 'none',
                                        transition: 'all 0.2s',
